...
# Test cases
test_cases = [
    (pd.DataFrame({"Total Economic Loss": [50000000, 200000000, 150000000]}), 0.4, "Normal case with multiple values"),
    ...
    (pd.DataFrame({"Total Economic Loss": [1000000000]}), 1.0, "Single value"),
    (pd.DataFrame({"Total Economic Loss": [1e10, 2e10, 3e10]}), 60.0, "Large values"),
    (pd.DataFrame({"Total Economic Loss": [-50000000, 200000000, -150000000]}), 0.0, "Negative values"),
    (pd.DataFrame({"Total Economic Loss": [0, 0, 0]}), 0, "Zero values")
]
